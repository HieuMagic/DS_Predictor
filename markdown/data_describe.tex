...
\begin{itemize}
    ...
    \item [!] \textbf{Imbalanced}: Xe sang chỉ $\sim$20\%, một số hãng rare <1\%
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Interim data}: \texttt{data/interim/} (4 files theo từng phase)
    \item \textbf{Final data}: \texttt{data/processed/preprocessing\_car\_features.csv}
\end{itemize}
